...
<div class="d-flex justify-content-center">
    <div class="form-container">
        ...
        <div>
            <button class="login-btn" onclick="model.signinWithGoogle()"><img
                    src="https://phukienbaominh.com/wp-content/uploads/2018/11/google-icon.jpg" width="30px" alt="">
                Log in with Google</button>
        </div>
        <div>
            <button class="login-btn" onclick="model.signinWithFacebook()">
                <img src="https://cdn.icon-icons.com/icons2/2108/PNG/512/facebook_icon_130940.png"
                    width="30px" style="border-radius: 50px;" alt=""> Log in with Facebook</button>
        </div>
        ...
        <div class="section pt-3 pt-md-5">
            <div class="d-flex justify-content-between align-items-center pb-2 pb-md-5">
                ...
                <div class="d-flex align-items-center">
                    <b onclick="to_register();" style="font-size: 18px; cursor: pointer;"
                        class="mx-2 navbar-link">SIGN
                        UP</b>
                    <b onclick="to_signin();" style="font-size: 18px; cursor: pointer;" class="mx-2 navbar-link">LOG
                        IN</b>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-5 d-flex flex-column justify-content-around py-5 fade-right"
                    style="height: 300px;">
